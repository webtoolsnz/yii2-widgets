...
(Base.extend = function (a, b) {
  ...
  (function (a) {
    ...
    (c.addClass = function (a, d) {
      return b
        ? a.classList.add(d)
        : void (c.hasClass(a, d) || (a.className += " " + d));
    }),
    ...
    a.commands.formatInline = {
      exec: function (a, c, d, e, f) {
        return (c = a.selection.getRange())
          ? (b(d, e, f).toggleRange(c), void a.selection.setSelection(c))
          : !1;
      },
  ...
  (function (a) {
    ...
    a.UndoManager = a.lang.Dispatcher.extend({
      ...
      set: function (a) {
        this.composer.setValue(a), this.editor.focus({});
      },
    });
  })(wysihtml5),
...
(this.wysihtml5 = this.wysihtml5 || {}),
  ...
  (this.wysihtml5.tpl.blockquote = Handlebars.template(function (
    ...
    return (
      ...
      (g || 0 === g) && (h += g),
      (h +=
        ' btn-secondary" data-wysihtml5-command="formatBlock" data-wysihtml5-command-value="blockquote" data-wysihtml5-display-format-name="false" tabindex="-1">\n    <span class="glyphicon glyphicon-quote"></span>\n  </a>\n</li>\n')
    );
  })),
  ...
  (this.wysihtml5.tpl.emphasis = Handlebars.template(function (a, b, c, d, e) {
    ...
    function g(a, b) {
      ...
      return (
        ...
        (d || 0 === d) && (e += d),
        (e +=
          ' btn-secondary" data-wysihtml5-command="small" title="CTRL+S" tabindex="-1">' +
          k(
            ((d = a && a.locale),
    ...
    return (
      ...
      (h || 0 === h) && (i += h),
      (i +=
        ' btn-secondary" data-wysihtml5-command="bold" title="CTRL+B" tabindex="-1">' +
        k(
          ((h = b && b.locale),
      ...
      (h || 0 === h) && (i += h),
      (i +=
        ' btn-secondary" data-wysihtml5-command="italic" title="CTRL+I" tabindex="-1">' +
        k(
          ((h = b && b.locale),
          (h = null == h || h === !1 ? h : h.emphasis),
      ...
      (h || 0 === h) && (i += h),
      (i +=
        ' btn-secondary" data-wysihtml5-command="underline" title="CTRL+U" tabindex="-1">' +
        k(
          ((h = b && b.locale),
          (h = null == h || h === !1 ? h : h.emphasis),
      ...
      (h = c["if"].call(
        b,
        ((h = b && b.options), null == h || h === !1 ? h : h.emSmall),
  ...
  (this.wysihtml5.tpl.html = Handlebars.template(function (a, b, c, d, e) {
    ...
    return (
      ...
      (g || 0 === g) && (h += g),
      (h +=
        ' btn-secondary" data-wysihtml5-action="change_view" title="' +
        j(
          ((g = b && b.locale),
  ...
  (this.wysihtml5.tpl.image = Handlebars.template(function (a, b, c, d, e) {
    ...
    return (
      ...
      (h = c["if"].call(
        b,
        ((h = b && b.options), null == h || h === !1 ? h : h.smallmodals),
        { hash: {}, inverse: l.noop, fn: l.program(1, f, e), data: e }
      )),
      (h || 0 === h) && (i += h),
      (i +=
        ...
        k(
          ((h = b && b.locale),
          (h = null == h || h === !1 ? h : h.image),
          (h = null == h || h === !1 ? h : h.insert),
          typeof h === j ? h.apply(b) : h)
        ) +
      ...
      (h || 0 === h) && (i += h),
      (i +=
        ' btn-secondary" data-wysihtml5-command="insertImage" title="' +
        k(
          ((h = b && b.locale),
          (h = null == h || h === !1 ? h : h.image),
          (h = null == h || h === !1 ? h : h.insert),
  ...
  (this.wysihtml5.tpl.link = Handlebars.template(function (a, b, c, d, e) {
    ...
    return (
      ...
      (h || 0 === h) && (i += h),
      (i +=
        ' btn-secondary" data-wysihtml5-command="createLink" title="' +
        k(
          ((h = b && b.locale),
          (h = null == h || h === !1 ? h : h.link),
          (h = null == h || h === !1 ? h : h.insert),
  ...
  (this.wysihtml5.tpl.lists = Handlebars.template(function (a, b, c, d, e) {
    ...
    return (
      ...
      (g || 0 === g) && (h += g),
      (h +=
        ' btn-secondary" data-wysihtml5-command="insertUnorderedList" title="' +
        j(
          ((g = b && b.locale),
      ...
      (g || 0 === g) && (h += g),
      (h +=
        ' btn-secondary" data-wysihtml5-command="insertOrderedList" title="' +
        j(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.lists),
      ...
      (g || 0 === g) && (h += g),
      (h +=
        ' btn-secondary" data-wysihtml5-command="Outdent" title="' +
        j(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.lists),
      ...
      (g || 0 === g) && (h += g),
      (h +=
        ' btn-secondary" data-wysihtml5-command="Indent" title="' +
        j(
          ((g = b && b.locale),
          (g = null == g || g === !1 ? g : g.lists),
      ...
      createEditor: function (c) {
        ...
        if (
          (this.addMoreShortcuts(
            d,
            d.currentView.iframe.contentDocument.body ||
              d.currentView.iframe.contentDocument,
            c.shortcuts
          ),
          c && c.events)
        )
