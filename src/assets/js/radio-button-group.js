    ...
    return this.each(function () {
      ...
      options = $.extend(
        {
          ...
          defaultState: "btn btn-secondary",
          change: $.noop,
          buttons: {},
        },
        options
      ...
      el.find("button").on("click", function (e) {
        var button = $(this),
          ...
          activeState =
            buttonOptions && buttonOptions["activeState"]
              ? buttonOptions["activeState"]
              : options["activeState"],
          defaultState =
            buttonOptions && buttonOptions["defaultState"]
              ? buttonOptions["defaultState"]
